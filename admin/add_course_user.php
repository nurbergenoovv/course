...
<body class="text-dark">
	<main class="container mt-5 mb-5 px-3">
		...
		<div class="btns">
			<a href="/admin/course_users.php?id=<?= $id ?>" class="btn btn-primary w-100 py-3 fw-semibold">Назад</a>
		</div>
		<form action="" method="post" class="form-input mt-3">
			<div class="inputs">
				<div class="input-label">
					<label for="email" class="label">Эл.почта</label>
					<input type="email" name="email" id="email" class="input-form" placeholder="Эл.почта">
				</div>
